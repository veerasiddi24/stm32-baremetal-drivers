...
typedef struct
{
    ...
    volatile uint32_t CNT;     // Counter (32-bit for TIM2)
...
#define TIM2 ((TIM2345_RegDef_t*)TIM2_BASE_ADDR)
...
#define TIM1_PCLK_EN() (RCC->APB2ENR |= (0x01<<11))
#define TIM2_PCLK_EN() (RCC->APB1ENR1 |= (0x01<<0))
