...
void GPIO_Config(void)
{
	...
	gpio_pin.GPIO_PinConfig.GPIO_PinNumber = 0;
	gpio_pin.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_OUTPUT;
	gpio_pin.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_PP;
	gpio_pin.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_NO_PUPD;
	gpio_pin.GPIO_PinConfig.GPIO_PinSpeed = 3;
    GPIO_Init(&gpio_pin);
}
...
void Button_Gpio_Config()
{
    ...
    Button_Pin.pGPIOx = GPIOC;
    Button_Pin.GPIO_PinConfig.GPIO_PinNumber = 13;
    Button_Pin.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_IT_FT;
    Button_Pin.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_PP;
    Button_Pin.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_NO_PUPD;
    Button_Pin.GPIO_PinConfig.GPIO_PinSpeed = 3;
...
{
	GPIO_Handle_t Tim_In_Cap_pin;

	Tim_In_Cap_pin.pGPIOx = GPIOA;
	Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinNumber = 8;
	Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinMode = GPIO_MODE_ALTFN;
	Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinOPType = GPIO_OP_TYPE_PP;
	Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinPuPdControl = GPIO_NO_PUPD;
    Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinSpeed = 3;
    Tim_In_Cap_pin.GPIO_PinConfig.GPIO_PinAltFunMode = AF1;
    GPIO_Init(&Tim_In_Cap_pin);
...
void SPI1_GPIO_Config(void)
{
    ...
    CS.pGPIOx = GPIOA;
    CS.GPIO_PinConfig.GPIO_PinNumber = 4;
    ...
    CS.GPIO_PinConfig.GPIO_PinSpeed = 3;
//    SPImosi.GPIO_PinConfig.GPIO_PinAltFunMode = AF5;
